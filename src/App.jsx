...
import CografyaApp from './CografyaApp.jsx'
...
export default function App() {
  ...
  if (view === 'cografya') return <CografyaApp onBack={() => setView('home')} />

  return (
    <div className="app">
      <div className="start-screen">
        <h1 className="start-title home-title">
          <span className="accent">KPSS</span> Çalışması
        </h1>
        ...
        <div className="start-choices home-choices">
          ...
          <button className="choice home-choice" onClick={() => setView('cografya')}>
            <span className="choice-title">Coğrafya — Madenler</span>
            <span className="choice-meta">Harita üzerinde test</span>
            <span className="choice-desc">
              Dilsiz Türkiye haritasında madenlerin çıkarıldığı alanlar ve işleme tesisleri.
            </span>
          </button>
        </div>
